          ...
          <ul class="b-table">
            <li v-for="beer in beers" :key=beer.id class="col">
              <b-card :title="beer.name" :sub-title="beer.brewery" class="own-card">
                ...
                <b-card-text>
                  <ul class="list">
                    <li><b-button @click.prevent="checkDoneList(beer)"><fa icon="thumbtack"/></b-button></li>
                    <li>||</li>
                    <li><b-button @click.prevent="checkHateList(beer)"><fa icon="hand-middle-finger"/></b-button></li>
                    <li>||</li>
                    <li><b-button @click.prevent="checkWishList(beer)"><fa icon="list"/></b-button></li>
                    <li>||</li>
                    <li><b-button @click.prevent="checkFavList(beer)"><fa icon="star" class="disable"/></b-button> {{beer.favRating}}</li>
                  </ul>
                </b-card-text>
  ...
  methods:{
    async checkFavList(beer){
      ...
      if(!foundBeer){
        ...
        console.log('Metemos la cerveza')
      } else {
        this.removeFav(beer)
        ...
        window.localStorage.setItem("beerFav",  JSON.stringify(favBeers))
        console.log('Sacamos la cerveza')
      }
    },
    async addFav(beer){
    ...
    async addFavBeer(beer){
      ...
      const response = await this.$axios.patch(`users/${userID}/favs`, null, {params: {fav: beer._id}})
    },
    async removeFavBeer(beer){
      const userID = window.localStorage.getItem('id')
      const response = await this.$axios.patch(`users/${userID}/favs`, null, {params: {unfav: beer._id}})
    },
    ...
    async addHateBeer(beer){
      const userID = window.localStorage.getItem('id')
      const response = await this.$axios.patch(`users/${userID}/hates`, null, {params: {hate: beer._id}})
    },
    async removeHateBeer(beer){
      const userID = window.localStorage.getItem('id')
      const response = await this.$axios.patch(`users/${userID}/hates`, null, {params: {unhate: beer._id}})
    },
    ...
    async addWishBeer(beer){
      const userID = window.localStorage.getItem('id')
      const response = await this.$axios.patch(`users/${userID}/wish`, null, {params: {wish: beer._id}})
    },
    async removeWishBeer(beer){
      const userID = window.localStorage.getItem('id')
      const response = await this.$axios.patch(`users/${userID}/wish`, null, {params: {unwish: beer._id}})
    },
    ...
    async addDoneBeer(beer){
      const userID = window.localStorage.getItem('id')
      const response = await this.$axios.patch(`users/${userID}/done`, null, {params: {done: beer._id}})
    },
    async removeDoneBeer(beer){
      const userID = window.localStorage.getItem('id')
      const response = await this.$axios.patch(`users/${userID}/done`, null, {params: {undone: beer._id}})
    },
  }
}
